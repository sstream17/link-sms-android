...
class ActivateWearActivity : Activity() {
    ...
    private fun queryEndpoint() {
        ...
        handler.postDelayed({
            Thread {
                ...
                val response: com.stream_suite.link.api.entity.LoginResponse? = try {
    ...
    private fun activated(response: com.stream_suite.link.api.entity.LoginResponse) {
    ...
    private fun checkPassword(response: com.stream_suite.link.api.entity.LoginResponse, password: String?) {
        ...
        Thread {
            val encryptionCreator = com.stream_suite.link.api.implementation.AccountEncryptionCreator(this@ActivateWearActivity, password)
            ...
            try {
                ...
                setResult(com.stream_suite.link.api.implementation.LoginActivity.RESULT_START_NETWORK_SYNC)
                finish()
            } catch (e: Exception) {
                runOnUiThread {
                    Toast.makeText(this@ActivateWearActivity, com.stream_suite.link.api.implementation.R.string.api_wrong_password,
