...
import com.stream_suite.link.fragment.bottom_sheet.LinkLongClickFragment
        ...
        urls.setOnClickListener { clickedText ->
            ...
            if (skipInternalBrowser(link) || !Settings.internalBrowser) {
                ...
                try {
                    ...
                    com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.caughtForceClose(holder.itemView.context, "couldn't start link click: $clickedText", e)
                }
            } else {
