...
open class InitialLoadActivity : AppCompatActivity(), ProgressUpdateListener {
    ...
    private fun startLogin() {
        ...
        val login = Intent(this, com.stream_suite.link.api.implementation.LoginActivity::class.java)
    ...
    private fun startDatabaseSync() {
        Thread {
            ...
            com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.importFinished(this, importTime)
