...
import com.stream_suite.link.shared.service.MessengerChooserTargetService
import com.stream_suite.link.shared.util.FileUtils
...
class ShareIntentHandler(private val page: QuickSharePage) {
    ...
    fun handle(intent: Intent) {
        ...
        try {
            ...
            com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.caughtForceClose(page.context, "caught when sharing to quick share activity", e)
        }
    }
