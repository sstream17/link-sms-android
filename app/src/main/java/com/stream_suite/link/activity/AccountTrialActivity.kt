...
class AccountTrialActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.accountStartTrialTutorial(this)
    ...
    private fun tryIt() {
        ...
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.accountAcceptFreeTrial(this)
