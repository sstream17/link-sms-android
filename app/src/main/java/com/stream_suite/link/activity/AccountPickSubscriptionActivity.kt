...
import com.stream_suite.link.shared.util.billing.ProductType
...
class AccountPickSubscriptionActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.accountTutorialStarted(this)
...
//            Toast.makeText(this, R.string.subscription_toast, Toast.LENGTH_LONG).show()
        ...
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.accountSelectedPurchase(this)
        finish()
    }

    private fun finishWithTrialCancellation() {
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.accountFreeTrialUpgradeDialogCancelClicked(this)
    ...
    private fun startSignIn() {
        ...
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.accountSignInInsteadOfPurchase(this)
