...
class OnboardingActivity : AppIntro() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.tutorialStarted(this)
    ...
    override fun onDonePressed(currentFragment: Fragment?) {
        ...
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.tutorialFinished(this)
    }
    ...
    override fun onSkipPressed(currentFragment: Fragment?) {
        ...
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.tutorialSkipped(this)
        com.stream_suite.link.api.implementation.firebase.AnalyticsHelper.tutorialFinished(this)
    }
}
