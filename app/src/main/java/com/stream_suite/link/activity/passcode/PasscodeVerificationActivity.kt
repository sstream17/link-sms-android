package com.stream_suite.link.activity.passcode
...
class AccountPasswordPage(context: FloatingTutorialActivity) : TutorialPage(context) {
    ...
    private fun verifyAccount(email: String, password: String) {
        ...
        dialog.setMessage(getActivity().getString(com.stream_suite.link.api.implementation.R.string.api_connecting))
        dialog.show()
        ...
        Thread {
            ...
            getActivity().runOnUiThread {
                ...
                if (response == null) {
                    Toast.makeText(getActivity(), com.stream_suite.link.api.implementation.R.string.api_login_error,
