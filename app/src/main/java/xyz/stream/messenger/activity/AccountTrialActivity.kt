...
class AccountTrialActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        xyz.stream.messenger.api.implementation.firebase.AnalyticsHelper.accountStartTrialTutorial(this)
    ...
    private fun tryIt() {
        ...
        xyz.stream.messenger.api.implementation.firebase.AnalyticsHelper.accountAcceptFreeTrial(this)
