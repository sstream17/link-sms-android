...
import xyz.stream.messenger.shared.util.billing.ProductAvailable
import xyz.stream.messenger.shared.util.billing.ProductType
...
class AccountPickSubscriptionActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        xyz.stream.messenger.api.implementation.firebase.AnalyticsHelper.accountTutorialStarted(this)
    ...
    private fun setUpPurchaseLayout() {
        xyz.stream.messenger.api.implementation.firebase.AnalyticsHelper.accountTutorialFinished(this)
...
//            Toast.makeText(this, R.string.subscription_toast, Toast.LENGTH_LONG).show()
        ...
        xyz.stream.messenger.api.implementation.firebase.AnalyticsHelper.accountSelectedPurchase(this)
        finish()
    }

    private fun finishWithTrialCancellation() {
        xyz.stream.messenger.api.implementation.firebase.AnalyticsHelper.accountFreeTrialUpgradeDialogCancelClicked(this)
    ...
    private fun startSignIn() {
        ...
        xyz.stream.messenger.api.implementation.firebase.AnalyticsHelper.accountSignInInsteadOfPurchase(this)
