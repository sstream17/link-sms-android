package xyz.stream.messenger.activity.passcode
...
class AccountPasswordPage(context: FloatingTutorialActivity) : TutorialPage(context) {
    ...
    private fun verifyAccount(email: String, password: String) {
        ...
        dialog.setMessage(getActivity().getString(xyz.stream.messenger.api.implementation.R.string.api_connecting))
        dialog.show()
        ...
        Thread {
            ...
            getActivity().runOnUiThread {
                ...
                if (response == null) {
                    Toast.makeText(getActivity(), xyz.stream.messenger.api.implementation.R.string.api_login_error,
