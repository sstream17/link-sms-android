...
import xyz.stream.messenger.fragment.bottom_sheet.LinkLongClickFragment
        ...
        urls.setOnClickListener { clickedText ->
            ...
            if (skipInternalBrowser(link) || !Settings.internalBrowser) {
                ...
                try {
                    ...
                    xyz.stream.messenger.api.implementation.firebase.AnalyticsHelper.caughtForceClose(holder.itemView.context, "couldn't start link click: $clickedText", e)
                }
            } else {
