        ...
        return messages!!.filter { it != null }
                .map {
                    ...
                    val messageText = when {
                        MimeType.isAudio(it.mimeType!!) -> "<i>" + getString(xyz.stream.messenger.shared.R.string.audio_message) + "</i>"
                        MimeType.isVideo(it.mimeType!!) -> "<i>" + getString(xyz.stream.messenger.shared.R.string.video_message) + "</i>"
                        MimeType.isVcard(it.mimeType!!) -> "<i>" + getString(xyz.stream.messenger.shared.R.string.contact_card) + "</i>"
                        MimeType.isStaticImage(it.mimeType) -> "<i>" + getString(xyz.stream.messenger.shared.R.string.picture_message) + "</i>"
                        it.mimeType == MimeType.IMAGE_GIF -> "<i>" + getString(xyz.stream.messenger.shared.R.string.gif_message) + "</i>"
                        MimeType.isExpandedMedia(it.mimeType) -> "<i>" + getString(xyz.stream.messenger.shared.R.string.media) + "</i>"
                        else -> it.data
                    }
