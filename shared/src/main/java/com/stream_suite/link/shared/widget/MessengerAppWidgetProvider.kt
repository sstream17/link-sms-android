...
package com.stream_suite.link.shared.widget
...
class MessengerAppWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val REFRESH_ACTION = "com.stream_suite.link.shared.widget.REFRESH"
        const val OPEN_ACTION = "com.stream_suite.link.shared.widget.OPEN"
        const val EXTRA_ITEM_ID = "com.stream_suite.link.shared.widget.EXTRA_ITEM_ID"
