...
import com.stream_suite.link.shared.data.YouTubePreview
import com.stream_suite.link.shared.util.UrlConnectionReader
...
class YoutubeParser(context: Context?) : MediaParser(context) {
    ...
    companion object {
        private val YOUTUBE_API_REQUEST = "https://www.googleapis.com/youtube/v3/videos" +
                "?id=<video-id>" +
                "&key=" + com.stream_suite.link.shared.BuildConfig.YOUTUBE_API_KEY +
