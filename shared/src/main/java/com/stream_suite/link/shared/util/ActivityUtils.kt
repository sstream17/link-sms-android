...
object ActivityUtils {
    ...
    val MESSENGER_ACTIVITY = ComponentName("com.stream_suite.link",
            "com.stream_suite.link" + ".activity.MessengerActivity")
    val BUBBLE_ACTIVITY = ComponentName("com.stream_suite.link",
            "com.stream_suite.link" + ".activity.BubbleActivity")
    val COMPOSE_ACTIVITY = ComponentName("com.stream_suite.link",
            "com.stream_suite.link" + ".activity.compose.ComposeActivity")
    val QUICK_SHARE_ACTIVITY = ComponentName("com.stream_suite.link",
            "com.stream_suite.link" + ".activity.share.QuickShareActivity")
    val NOTIFICATION_REPLY = ComponentName("com.stream_suite.link",
            "com.stream_suite.link" + ".activity.notification.MarshmallowReplyActivity")
