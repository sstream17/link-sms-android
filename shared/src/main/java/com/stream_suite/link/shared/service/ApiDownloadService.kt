...
class ApiDownloadService : Service() {
    ...
    private fun downloadMessages(conversations: List<Conversation>) {
        ...
        do {
            val messages = try {
                ...
                emptyArray<com.stream_suite.link.api.entity.MessageBody>()
            }
    ...
    private fun downloadConversations(): List<Conversation> {
        ...
        do {
            val conversations = try {
                ...
                emptyArray<com.stream_suite.link.api.entity.ConversationBody>()
            }
    ...
    private fun downloadBlacklists() {
        ...
        val blacklists = try {
            ...
            emptyArray<com.stream_suite.link.api.entity.BlacklistBody>()
        }
    ...
    private fun downloadScheduledMessages() {
        ...
        val messages = try {
            ...
            emptyArray<com.stream_suite.link.api.entity.ScheduledMessageBody>()
        }
    ...
    private fun downloadDrafts() {
        ...
        val drafts = try {
            ...
            emptyArray<com.stream_suite.link.api.entity.DraftBody>()
        }
    ...
    private fun downloadContacts() {
        ...
        do {
            val contacts = try {
                ...
                emptyArray<com.stream_suite.link.api.entity.ContactBody>()
            }
    ...
    private fun downloadTemplates() {
        ...
        val templates = try {
            ...
            emptyArray<com.stream_suite.link.api.entity.TemplateBody>()
        }
    ...
    private fun downloadFolders() {
        ...
        val folders = try {
            ...
            emptyArray<com.stream_suite.link.api.entity.FolderBody>()
        }
    ...
    private fun downloadAutoReplies() {
        ...
        val replies = try {
            ...
            emptyArray<com.stream_suite.link.api.entity.AutoReplyBody>()
        }
        ...
        try {
            ...
            if (media.moveToFirst()) {
                ...
                do {
                    ...
                    ApiUtils.downloadFileFromFirebase(Account.accountId, file, message.id, encryptionUtils, com.stream_suite.link.api.implementation.firebase.FirebaseDownloadCallback {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD_FINISHED = "com.stream_suite.link.API_DOWNLOAD_FINISHED"
