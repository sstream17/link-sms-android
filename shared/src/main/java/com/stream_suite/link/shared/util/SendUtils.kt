...
import com.stream_suite.link.shared.receiver.MmsSentReceiver
import com.stream_suite.link.shared.receiver.SmsDeliveredReceiver
import com.stream_suite.link.shared.receiver.SmsSentReceiver
import com.stream_suite.link.shared.receiver.SmsSentReceiverNoRetry
import com.stream_suite.link.shared.service.jobs.MarkAsSentWork
...
class SendUtils constructor(private val subscriptionId: Int? = null) {
    ...
    fun send(context: Context, text: String, addresses: Array<String>, data: Uri? = null, mimeType: String? = null): Uri? {
        ...
        val appSettings = com.stream_suite.link.shared.data.Settings
