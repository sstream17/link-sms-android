...
import com.stream_suite.link.shared.service.jobs.SignoutJob
...
class FirebaseHandlerService : IntentService("FirebaseHandlerService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        if (intent != null && intent.action != null && intent.action == com.stream_suite.link.api.implementation.firebase.MessengerFirebaseMessagingService.ACTION_FIREBASE_MESSAGE_RECEIVED) {
            val operation = intent.getStringExtra(com.stream_suite.link.api.implementation.firebase.MessengerFirebaseMessagingService.EXTRA_OPERATION)
            val data = intent.getStringExtra(com.stream_suite.link.api.implementation.firebase.MessengerFirebaseMessagingService.EXTRA_DATA)
    ...
    companion object {
        ...
        @Throws(JSONException::class)
        private fun addMessage(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
        ...
        private fun addMessageAfterFirebaseDownload(context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils, message: Message, to: String? = null) {
            ...
            val callback = com.stream_suite.link.api.implementation.firebase.FirebaseDownloadCallback {
                ...
                if (to != null) {
                    val bytes = com.stream_suite.link.api.implementation.BinaryUtils.getMediaBytes(context, message.data, message.mimeType, true)
                    ApiUtils.uploadBytesToFirebase(Account.accountId, bytes, message.id, encryptionUtils, com.stream_suite.link.api.implementation.firebase.FirebaseUploadCallback { }, 0)
                }
            }
        ...
        @Throws(JSONException::class)
        private fun addConversation(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
        ...
        @Throws(JSONException::class)
        private fun updateContact(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            try {
                val contact = Contact()
        ...
        @Throws(JSONException::class)
        private fun addContact(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
        ...
        @Throws(JSONException::class)
        private fun updateConversation(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            try {
                val conversation = Conversation()
                conversation.id = getLong(json, "id")
                conversation.title = encryptionUtils!!.decrypt(json.getString("title"))
        ...
        @Throws(JSONException::class)
        private fun updateConversationTitle(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            try {
        ...
        @Throws(JSONException::class)
        private fun updateConversationSnippet(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            try {
        ...
        @Throws(JSONException::class)
        private fun addDraft(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            val draft = Draft()
        ...
        @Throws(JSONException::class)
        private fun addBlacklist(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            val id = getLong(json, "id")
        ...
        @Throws(JSONException::class)
        private fun addScheduledMessage(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
        ...
        @Throws(JSONException::class)
        private fun updatedScheduledMessage(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            val message = ScheduledMessage()
            message.id = getLong(json, "id")
            message.to = encryptionUtils!!.decrypt(json.getString("to"))
            message.data = encryptionUtils.decrypt(json.getString("data"))
        ...
        @Throws(JSONException::class)
        private fun addTemplate(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
        ...
        @Throws(JSONException::class)
        private fun updateTemplate(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            val template = Template()
            template.id = getLong(json, "device_id")
            template.text = encryptionUtils!!.decrypt(json.getString("text"))
        ...
        @Throws(JSONException::class)
        private fun addAutoReply(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            val reply = AutoReply()
        ...
        @Throws(JSONException::class)
        private fun updateAutoReply(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            val reply = AutoReply()
            reply.id = getLong(json, "device_id")
            reply.type = json.getString("type")
            reply.pattern = encryptionUtils!!.decrypt(json.getString("pattern"))
        ...
        @Throws(JSONException::class)
        private fun addFolder(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            val folder = Folder()
        ...
        @Throws(JSONException::class)
        private fun updateFolder(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            val folder = Folder()
            folder.id = getLong(json, "device_id")
            folder.name = encryptionUtils!!.decrypt(json.getString("name"))
            folder.colors.color = json.getInt("color")
        ...
        @Throws(JSONException::class)
        private fun forwardToPhone(json: JSONObject, context: Context, encryptionUtils: com.stream_suite.link.encryption.EncryptionUtils?) {
            if (!Account.primary) {
                return
            }
