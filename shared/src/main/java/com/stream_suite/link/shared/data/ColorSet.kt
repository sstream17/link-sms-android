...
import com.stream_suite.link.shared.util.ColorConverter
...
class ColorSet {
    ...
    companion object {
        ...
        fun DEFAULT(context: Context): ColorSet {
            if (defaultSet == null) {
                defaultSet = ColorSet(context, R.color.linkColorPrimary, R.color.linkColorPrimaryDark,
                        R.color.linkColorPrimaryLight, R.color.linkColorAccent)
            }
