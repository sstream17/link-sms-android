...
import xyz.stream.messenger.shared.receiver.MmsSentReceiver
import xyz.stream.messenger.shared.receiver.SmsDeliveredReceiver
import xyz.stream.messenger.shared.receiver.SmsSentReceiver
import xyz.stream.messenger.shared.receiver.SmsSentReceiverNoRetry
import xyz.stream.messenger.shared.service.jobs.MarkAsSentWork
...
class SendUtils constructor(private val subscriptionId: Int? = null) {
    ...
    fun send(context: Context, text: String, addresses: Array<String>, data: Uri? = null, mimeType: String? = null): Uri? {
        ...
        val appSettings = xyz.stream.messenger.shared.data.Settings
