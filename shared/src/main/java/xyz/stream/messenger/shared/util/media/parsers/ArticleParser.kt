package xyz.stream.messenger.shared.util.media.parsers
...
import xyz.stream.messenger.shared.data.ArticlePreview
import xyz.stream.messenger.shared.data.MimeType
import xyz.stream.messenger.shared.util.Regex
import xyz.stream.messenger.shared.util.media.MediaParser
...
class ArticleParser(context: Context?) : MediaParser(context) {
    ...
    companion object {
        val ARTICLE_API_KEY = xyz.stream.messenger.shared.BuildConfig.ARTICLE_API_KEY
    }
}
