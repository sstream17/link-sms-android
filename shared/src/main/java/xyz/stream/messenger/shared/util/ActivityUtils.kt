...
object ActivityUtils {
    ...
    val MESSENGER_ACTIVITY = ComponentName("xyz.stream.messenger",
            "xyz.stream.messenger" + ".activity.MessengerActivity")
    val BUBBLE_ACTIVITY = ComponentName("xyz.stream.messenger",
            "xyz.stream.messenger" + ".activity.BubbleActivity")
    val COMPOSE_ACTIVITY = ComponentName("xyz.stream.messenger",
            "xyz.stream.messenger" + ".activity.compose.ComposeActivity")
    val QUICK_SHARE_ACTIVITY = ComponentName("xyz.stream.messenger",
            "xyz.stream.messenger" + ".activity.share.QuickShareActivity")
    val NOTIFICATION_REPLY = ComponentName("xyz.stream.messenger",
            "xyz.stream.messenger" + ".activity.notification.MarshmallowReplyActivity")
