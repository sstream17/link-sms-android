...
class ApiDownloadService : Service() {
    ...
    private fun downloadMessages() {
        ...
        do {
            val messages = try {
                ...
                emptyArray<xyz.stream.messenger.api.entity.MessageBody>()
            }
    ...
    private fun downloadConversations() {
        ...
        do {
            val conversations = try {
                ...
                emptyArray<xyz.stream.messenger.api.entity.ConversationBody>()
            }
    ...
    private fun downloadBlacklists() {
        ...
        val blacklists = try {
            ...
            emptyArray<xyz.stream.messenger.api.entity.BlacklistBody>()
        }
    ...
    private fun downloadScheduledMessages() {
        ...
        val messages = try {
            ...
            emptyArray<xyz.stream.messenger.api.entity.ScheduledMessageBody>()
        }
    ...
    private fun downloadDrafts() {
        ...
        val drafts = try {
            ...
            emptyArray<xyz.stream.messenger.api.entity.DraftBody>()
        }
    ...
    private fun downloadContacts() {
        ...
        do {
            val contacts = try {
                ...
                emptyArray<xyz.stream.messenger.api.entity.ContactBody>()
            }
    ...
    private fun downloadTemplates() {
        ...
        val templates = try {
            ...
            emptyArray<xyz.stream.messenger.api.entity.TemplateBody>()
        }
    ...
    private fun downloadFolders() {
        ...
        val folders = try {
            ...
            emptyArray<xyz.stream.messenger.api.entity.FolderBody>()
        }
    ...
    private fun downloadAutoReplies() {
        ...
        val replies = try {
            ...
            emptyArray<xyz.stream.messenger.api.entity.AutoReplyBody>()
        }
        ...
        try {
            ...
            if (media.moveToFirst()) {
                ...
                do {
                    ...
                    ApiUtils.downloadFileFromFirebase(Account.accountId, file, message.id, encryptionUtils, xyz.stream.messenger.api.implementation.firebase.FirebaseDownloadCallback {
