...
import xyz.stream.messenger.api.entity.AddContactRequest
import xyz.stream.messenger.api.entity.ContactBody
...
class ContactSyncWork(private val context: Context, params: WorkerParameters) : Worker(context, params) {
    ...
    override fun doWork(): Result {
        ...
        val contacts = arrayOfNulls<xyz.stream.messenger.api.entity.ContactBody>(contactsList.size)
        ...
        val request = xyz.stream.messenger.api.entity.AddContactRequest(Account.accountId, contacts)
